...
def load_template(request, template_name):
    allowed_templates = ['noticias.html', 'perfil_usuario.html', 'recibo_pago.html',
                        'constancia_trabajo.html', 'arc.html','importar_nomina.html', 'gestionar_nomina.html']  # Añade todos tus templates
...
def serve_js(request, script_name):
    ...
    allowed_scripts = ['noticias.js', 'perfil_usuario.js','recibo_pago.js',
                        'constancia_trabajo.js', 'arc.js', 'importar_nomina.js', 'gestionar_nomina.js']  # Añade todos tus scripts aquí
...
def gestionar_nomina(request):
    return render(request, 'menu_principal/subs_menus/gestionar_nomina.html')
